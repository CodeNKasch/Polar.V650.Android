...
.method private downloadTile(Lorg/mapsforge/map/layer/download/DownloadJob;)V
    ...
    .prologue
    .line 80
    new-instance v1, Lorg/mapsforge/map/layer/download/TileDownloader;

    iget-object v2, p0, Lorg/mapsforge/map/layer/download/TileDownloadThread;->graphicFactory:Lorg/mapsforge/core/graphics/GraphicFactory;

    invoke-direct {v1, p1, v2}, Lorg/mapsforge/map/layer/download/TileDownloader;-><init>(Lorg/mapsforge/map/layer/download/DownloadJob;Lorg/mapsforge/core/graphics/GraphicFactory;)V

    .line 81
    .local v1, "tileDownloader":Lorg/mapsforge/map/layer/download/TileDownloader;
    invoke-virtual {v1}, Lorg/mapsforge/map/layer/download/TileDownloader;->downloadImage()Lorg/mapsforge/core/graphics/TileBitmap;
    ...
    invoke-interface {v0, v2, v3}, Lorg/mapsforge/core/graphics/TileBitmap;->scaleTo(II)V
    ...
    invoke-interface {v2, p1, v0}, Lorg/mapsforge/map/layer/cache/TileCache;->put(Lorg/mapsforge/map/layer/queue/Job;Lorg/mapsforge/core/graphics/TileBitmap;)V
...
.method protected doWork()V
    ...
    invoke-virtual {v2}, Lorg/mapsforge/map/layer/queue/JobQueue;->get()Lorg/mapsforge/map/layer/queue/Job;
    ...
    invoke-interface {v2, v0}, Lorg/mapsforge/map/layer/cache/TileCache;->containsKey(Lorg/mapsforge/map/layer/queue/Job;)Z
    ...
    iget-object v3, p0, Lorg/mapsforge/map/layer/download/TileDownloadThread;->jobQueue:Lorg/mapsforge/map/layer/queue/JobQueue;

    invoke-virtual {v3, v0}, Lorg/mapsforge/map/layer/queue/JobQueue;->remove(Lorg/mapsforge/map/layer/queue/Job;)V
