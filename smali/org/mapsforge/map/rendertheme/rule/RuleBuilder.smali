...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/mapsforge/map/rendertheme/rule/RuleBuilder$1;
    }
.end annotation
...
.method private extractValues(Ljava/lang/String;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    sget-object v4, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->SPLIT_PATTERN:Ljava/util/regex/Pattern;

    iget-object v5, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->keys:Ljava/lang/String;
    ...
    iput-object v3, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->keyList:Ljava/util/List;
    ...
    iget-object v5, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->values:Ljava/lang/String;
    ...
    iput-object v3, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->valueList:Ljava/util/List;

    .line 165
    iget-object v3, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->element:Lorg/mapsforge/map/rendertheme/rule/Element;

    invoke-static {v3}, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->getElementMatcher(Lorg/mapsforge/map/rendertheme/rule/Element;)Lorg/mapsforge/map/rendertheme/rule/ElementMatcher;

    move-result-object v3

    iput-object v3, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->elementMatcher:Lorg/mapsforge/map/rendertheme/rule/ElementMatcher;

    .line 166
    iget-object v3, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->closed:Lorg/mapsforge/map/rendertheme/rule/Closed;

    invoke-static {v3}, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->getClosedMatcher(Lorg/mapsforge/map/rendertheme/rule/Closed;)Lorg/mapsforge/map/rendertheme/rule/ClosedMatcher;

    move-result-object v3

    iput-object v3, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->closedMatcher:Lorg/mapsforge/map/rendertheme/rule/ClosedMatcher;

    .line 168
    iget-object v3, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->elementMatcher:Lorg/mapsforge/map/rendertheme/rule/ElementMatcher;

    iget-object v4, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->ruleStack:Ljava/util/Stack;

    invoke-static {v3, v4}, Lorg/mapsforge/map/rendertheme/rule/RuleOptimizer;->optimize(Lorg/mapsforge/map/rendertheme/rule/ElementMatcher;Ljava/util/Stack;)Lorg/mapsforge/map/rendertheme/rule/ElementMatcher;
    ...
    .line 169
    iget-object v3, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->closedMatcher:Lorg/mapsforge/map/rendertheme/rule/ClosedMatcher;

    iget-object v4, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->ruleStack:Ljava/util/Stack;

    invoke-static {v3, v4}, Lorg/mapsforge/map/rendertheme/rule/RuleOptimizer;->optimize(Lorg/mapsforge/map/rendertheme/rule/ClosedMatcher;Ljava/util/Stack;)Lorg/mapsforge/map/rendertheme/rule/ClosedMatcher;
...
.method private static getKeyMatcher(Ljava/util/List;)Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;
    ...
    .line 76
    new-instance v0, Lorg/mapsforge/map/rendertheme/rule/KeyMatcher;

    .end local v0    # "attributeMatcher":Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;
    invoke-direct {v0, p0}, Lorg/mapsforge/map/rendertheme/rule/KeyMatcher;-><init>(Ljava/util/List;)V

    .line 77
    .restart local v0    # "attributeMatcher":Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;
    sget-object v1, Lorg/mapsforge/map/rendertheme/rule/Rule;->MATCHERS_CACHE_KEY:Ljava/util/Map;
...
.method private static getValueMatcher(Ljava/util/List;)Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;
    ...
    .line 89
    new-instance v0, Lorg/mapsforge/map/rendertheme/rule/ValueMatcher;

    .end local v0    # "attributeMatcher":Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;
    invoke-direct {v0, p0}, Lorg/mapsforge/map/rendertheme/rule/ValueMatcher;-><init>(Ljava/util/List;)V
...
.method public build()Lorg/mapsforge/map/rendertheme/rule/Rule;
    ...
    .prologue
    .line 122
    iget-object v3, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->valueList:Ljava/util/List;
    ...
    iget-object v3, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->keyList:Ljava/util/List;

    iget-object v4, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->valueList:Ljava/util/List;

    invoke-direct {v0, v3, v4}, Lorg/mapsforge/map/rendertheme/rule/NegativeMatcher;-><init>(Ljava/util/List;Ljava/util/List;)V

    .line 124
    .local v0, "attributeMatcher":Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;
    new-instance v3, Lorg/mapsforge/map/rendertheme/rule/NegativeRule;

    invoke-direct {v3, p0, v0}, Lorg/mapsforge/map/rendertheme/rule/NegativeRule;-><init>(Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;)V
    ...
    invoke-static {v3}, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->getKeyMatcher(Ljava/util/List;)Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;

    move-result-object v1

    .line 128
    .local v1, "keyMatcher":Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;
    iget-object v3, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->valueList:Ljava/util/List;

    invoke-static {v3}, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->getValueMatcher(Ljava/util/List;)Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;

    move-result-object v2

    .line 130
    .local v2, "valueMatcher":Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;
    iget-object v3, p0, Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;->ruleStack:Ljava/util/Stack;

    invoke-static {v1, v3}, Lorg/mapsforge/map/rendertheme/rule/RuleOptimizer;->optimize(Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;Ljava/util/Stack;)Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;
    ...
    invoke-static {v2, v3}, Lorg/mapsforge/map/rendertheme/rule/RuleOptimizer;->optimize(Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;Ljava/util/Stack;)Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;

    move-result-object v2

    .line 133
    new-instance v3, Lorg/mapsforge/map/rendertheme/rule/PositiveRule;

    invoke-direct {v3, p0, v1, v2}, Lorg/mapsforge/map/rendertheme/rule/PositiveRule;-><init>(Lorg/mapsforge/map/rendertheme/rule/RuleBuilder;Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;Lorg/mapsforge/map/rendertheme/rule/AttributeMatcher;)V
